# Created on: 6 Nov 2026
# Author: Oleg Zaikin
# E-mail: zaikin.icc@gmail.com
#
# For a given order n, produce a CNF that encodes the search for 3 Latin squares 
# A,B,C of order n such that the A is orthogonal to B and C, yet B is not orthogonal to C.
# The SAT encoding is CP-index
# proposed in
...
script = "cp-index_sat_pseudotriple.py"
version = "0.0.1"
